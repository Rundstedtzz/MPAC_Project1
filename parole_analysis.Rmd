...
parole_text_1$StoreId <- as.numeric(str_extract(string = paste(parole_text_1$id, collapse = " "), pattern = pattern))

parole_text_1 <- left_join(parole_text_1, 
                           parole_data,
                           by = "StoreId")
