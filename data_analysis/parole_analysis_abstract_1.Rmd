...
parole_sub2 %>%
  ...
  labs(subtitle = "from abstract", y = "word", x = "count/frequency")
```

##Use parole_analysis_data_4

```{r}
common_negative_words <- parole_abstract %>%
